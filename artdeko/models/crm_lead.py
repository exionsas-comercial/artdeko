...
class Lead(models.Model):
    ...
    planned_revenue = fields.Char(required=True)
    probability = fields.Char(required=True)
    date_deadline = fields.Char(required=True)
    tags_ids = fields.Char(required=True)